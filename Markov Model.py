...
class PatientStateMonitor:
    ...
    def update(self, k, next_state):
        ...
        if next_state in [P.HealthStats.STROKE_DEATH, P.HealthStats.DEATH]:
    ...
    def get_if_alive(self):
        result = True
        if self._currentState in [P.HealthStats.STROKE_DEATH, P.HealthStats.DEATH]:
            result = False
        return result
...
class PatientCostUtilityMonitor:
    ...
    def update(self, k, current_state, next_state):
        ...
        if current_state is P.HealthStats.POST_STROKE:
            if next_state is [P.HealthStats.DEATH, P.HealthStats.STROKE_DEATH]:
